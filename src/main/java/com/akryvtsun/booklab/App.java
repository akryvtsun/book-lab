...
public class App {
    ...
    public static void main(String[] args) {
        ...
        item.addListener(SWT.Selection, e -> {
            ...
            hBar.addListener(SWT.Selection, o -> {
            ...
            vBar.addListener(SWT.Selection, o -> {
            ...
            canvas.addListener(SWT.Resize, o -> {
                Rectangle rect = image.getBounds();
            ...
            canvas.addListener(SWT.Paint, o -> {
                GC gc = o.gc;
